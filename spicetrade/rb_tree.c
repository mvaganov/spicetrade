...
struct rb_node *
rb_node_alloc () {
    return (struct rb_node*)malloc(sizeof(struct rb_node));
}
...
struct rb_tree *
rb_tree_alloc () {
    return (struct rb_tree*)malloc(sizeof(struct rb_tree));
}
...
struct rb_iter *
rb_iter_alloc () {
    return (struct rb_iter*)malloc(sizeof(struct rb_iter));
}
