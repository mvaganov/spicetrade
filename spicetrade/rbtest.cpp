...
// int main(int argc, char * argv[])
// {
// 	RBT<int, int> * dNums = RBT<int,int>::create(NULL);
// 	dNums->insert((void*)5);
// 	dNums->insert((void*)1);
// 	dNums->insert((void*)54);
// 	dNums->insert((void*)35);
// 	dNums->insert((void*)350);
// 	dNums->insert((void*)450);
// 	dNums->insert((void*)451);
// 	dNums->insert((void*)452);
// 	dNums->insert((void*)453);
// 	dNums->insert((void*)454);
// 	dNums->insert((void*)455);

// 	RBT<int,int>::Node* n = dNums->root;
// 	printf("hi %d\n", n->value);
// 	return 0;
// }