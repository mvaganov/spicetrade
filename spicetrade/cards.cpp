...
const ResourceType resources[] = {
    ResourceType("Resource", '#', PLATFORM_COLOR_RED | PLATFORM_COLOR_GREEN | PLATFORM_COLOR_INTENSITY),
    ResourceType("Labor", '&', PLATFORM_COLOR_RED | PLATFORM_COLOR_INTENSITY),
    ResourceType("Goods", '@', PLATFORM_COLOR_GREEN | PLATFORM_COLOR_INTENSITY),
    ResourceType("Knowledge", '%', PLATFORM_COLOR_BLUE | PLATFORM_COLOR_INTENSITY),
    ResourceType("Anything", '.', PLATFORM_COLOR_RED | PLATFORM_COLOR_GREEN | PLATFORM_COLOR_BLUE),
    ResourceType("Something better", '+', PLATFORM_COLOR_RED | PLATFORM_COLOR_GREEN | PLATFORM_COLOR_BLUE | PLATFORM_COLOR_INTENSITY),
};
...
const Objective objective[] = {
    Objective("##&&",  6,  "public meeting space"),
    Objective("###&&", 7,  "common spaces"),
    Objective("&&&&",  8,  "culture"),
    Objective("##@@",  8,  "market place"),
    Objective("##&&&", 8,  "social work"),
    Objective("###@@", 9,  ""),
...
const PlayAction play_deck[] = {
    ...
    PlayAction("&",    "###",   "utilize laborers"),
    PlayAction("",     "#&",    "negotiate"),
    PlayAction("",     "@",     "repurpose and reuse"),
    PlayAction("",	   "###",   "explore"),
    PlayAction("...",  "+++",   "execute on good fortune"),
    ...
    PlayAction("",     "####",  "inherit/steal"),
    PlayAction("",     "%",     "genius"),
    PlayAction("",     "&&",    "leadership"),
    PlayAction("",     "#@",    "borrow"),
    PlayAction("##",   "@",     "craft"),
    PlayAction("&#",   "%",     "hire smart people"),
    ...
    PlayAction("%%",   "@@@&#", "verify quality during production"),
    PlayAction("#####","@@@",   "manufacture"),
    PlayAction("@##",  "%%",    "contract experts"),
    PlayAction("@@@",  "%%%",   "conference with experts"),
    PlayAction("&&&",  "@@@",   "plain-old hard work"),
    PlayAction("###",  "&&&",   "hire the right people"),
    PlayAction("##",   "&&",    "hire people"),
    PlayAction("@@",   "%%",    "test your process"),
    PlayAction("&&",   "@@",    "iterate"),
    PlayAction("%",	   "@@",    "invent")
};
